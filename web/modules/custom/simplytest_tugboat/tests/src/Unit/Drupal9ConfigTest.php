        ...
        'php' => [
          ...
          'commands' => [
            'build' => [
              ...
              'cd stm && composer require drupal/token:1.9 --no-install',
              'echo "SIMPLYEST_STAGE_PATCHING"',
              'composer global config --no-interaction allow-plugins.szeidler/composer-patches-cli true',
              ...
              'cd stm && composer patch-add drupal/token "STM patch 3185080-3.patch" "https://www.drupal.org/files/issues/2020-12-07/3185080-3.patch" --no-update',
              'cd stm && composer update --no-ansi',
              'echo "SIMPLYEST_STAGE_INSTALLING"',
              'cd "${DOCROOT}" && ../vendor/bin/drush si standard --db-url=mysql://tugboat:tugboat@mysql:3306/tugboat --account-name=admin --account-pass=admin -y',
              'cd "${DOCROOT}" && ../vendor/bin/drush config-set system.logging error_level verbose -y',
        ...
        'php' => [
          ...
          'commands' => [
            'build' => [
              ...
              'composer global require szeidler/composer-patches-cli:~1.0',
              'cd stm && composer patch-enable --file="patches.json"',
              'cd stm && composer patch-add drupal/core "STM patch 3185080-3.patch" "https://www.drupal.org/files/issues/2020-12-07/3185080-3.patch" --no-update',
              'cd stm && composer update --no-ansi',
              'echo "SIMPLYEST_STAGE_INSTALLING"',
              'cd "${DOCROOT}" && ../vendor/bin/drush si demo_umami --db-url=mysql://tugboat:tugboat@mysql:3306/tugboat --account-name=admin --account-pass=admin -y',
              'cd "${DOCROOT}" && ../vendor/bin/drush config-set system.logging error_level verbose -y',
        ...
        'php' => [
          ...
          'commands' => [
            'build' => [
              ...
              'cd stm && composer config minimum-stability dev',
              'cd stm && composer config prefer-stable true',
              'cd stm && composer require --dev --no-install drupal/core:9.1.5 drupal/core-dev:9.1.5',
              'cd stm && composer require --no-install drush/drush',
              'ln -snf "${TUGBOAT_ROOT}/stm/web" "${DOCROOT}"',
              'echo "SIMPLYEST_STAGE_DOWNLOAD"',
              'cd stm && composer require drupal/token:1.9 --no-install',
        ...
        'php' => [
          ...
          'commands' => [
            'build' => [
              ...
              'cd stm && composer config minimum-stability dev',
              'cd stm && composer config prefer-stable true',
              'cd stm && composer require --dev --no-install drupal/core:9.3.x-dev drupal/core-dev:9.3.x-dev',
              'cd stm && composer require --dev --no-install phpspec/prophecy-phpunit:^2',
              'cd stm && composer require --no-install drush/drush',
              'ln -snf "${TUGBOAT_ROOT}/stm/web" "${DOCROOT}"',
              'echo "SIMPLYEST_STAGE_DOWNLOAD"',
        ...
        'php' => [
          ...
          'commands' => [
            'build' => [
              ...
              'cd stm && composer config minimum-stability dev',
              'cd stm && composer config prefer-stable true',
              'cd stm && composer require --dev --no-install drupal/core:9.1.9 drupal/core-dev:9.1.9',
              'cd stm && composer require --dev --no-install phpspec/prophecy-phpunit:^2',
              'cd stm && composer require --no-install drush/drush',
              'ln -snf "${TUGBOAT_ROOT}/stm/web" "${DOCROOT}"',
              'echo "SIMPLYEST_STAGE_DOWNLOAD"',
