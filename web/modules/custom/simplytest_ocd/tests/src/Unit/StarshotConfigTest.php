      ...
      'php' => [
        ...
        'commands' => [
          'build' => [
            ...
            'cd ${DOCROOT} && ../vendor/bin/drush si minimal --db-url=mysql://tugboat:tugboat@mysql:3306/tugboat --account-name=admin --account-pass=admin -y --site-name="Drupal CMS Demo"',
            'cd ${DOCROOT} && ../vendor/bin/drush recipe ../recipes/drupal_cms_starter',
