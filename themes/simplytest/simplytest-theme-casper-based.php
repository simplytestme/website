 ...
 */
function simplytest_preprocess_node(&$variables){
  _simplytest_images($variables);
}

/**
 * Implements hook_preprocess_page().
 */
function simplytest_preprocess_page(&$variables, &$node){
  _simplytest_images($variables);
}
 ...
 */
function simplytest_form_system_theme_settings_alter(&$form, $form_state) {
...
function _simplytest_images(&$variables){
